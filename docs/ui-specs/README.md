...
| `stories.md` | stories (new) | 211 (reuses 402 loader/paginate) | `/en/` "Latest Stories" feed | CAPTURED |
...
| `social-share.md` | share (chrome) | COM-15 / STO-D10 | story detail | CAPTURED |
...
| COM-15 | Social Share | social-share | 304 (+ story detail) |
...
| STO-H02 | Latest Stories | stories | 211 (402 reuse) |
...
| STO-D10 | Social Share | social-share | 304 / story detail |
