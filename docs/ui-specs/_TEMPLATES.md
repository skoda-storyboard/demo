...
> - **MR side covers 16 M1 URLs** (press releases, model pages, press kits, Images, Videos). They need the MR nav + footer resolved per path (SKODA-825). Every source template also carries a floating share + scroll-top dock (SKODA-824).
