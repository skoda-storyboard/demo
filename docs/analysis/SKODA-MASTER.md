...
| **M1 URL → block registry** (2026-09-25): every UI element on the 43 M1 URLs, DevTools-measured source vs EDS, mapped to spec, block, ticket and status. Plus the sweep report (coverage, deltas, new tickets 825–827, AC amendments; reconciled with the parallel sweep `SKODA-DEMO-SWEEP-REPORT.md`, where 825/827 duplicate 309/215) | `analysis/SKODA-M1-URL-BLOCK-REGISTRY.md` (+ `.json`) · `reviews/SKODA-M1-URL-BLOCK-SWEEP.md` |
