...
| **M1 URL → block registry** (2026-09-25): every UI element on the 43 M1 URLs, DevTools-measured source vs EDS, mapped to spec, block, ticket and status. Plus the sweep report (coverage, deltas, new tickets 824–826, AC amendments) | `analysis/SKODA-M1-URL-BLOCK-REGISTRY.md` (+ `.json`) · `reviews/SKODA-M1-URL-BLOCK-SWEEP.md` |
