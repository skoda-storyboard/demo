...
| ❌ no ticket at sweep time → new ticket drafted (float dock and MR side are now owned by main-first 215 / 309; drafts 827 / 825 were folded in and removed) | 84 | | MATCH | 6 |
...
|---|---|---|---|---|--:|--:|---|--:|
| **header-megamenu** | Topbar, section switcher, wordmark, desktop nav + mega-menu, search trigger | header-megamenu.md | header | 301, 403 (search), 309 (MR nav; draft 825 folded in) | 3 | 12 | 🟡5 🔵3 ⚠️4 | 4 / 7 |
...
| **footer-mediaroom** | MR footer: Contacts/Subscribe/Company, MR legal | footer-mediaroom.md | footer (+ newsletter-stub, PR #134) | 305, 309 (routing; draft 825 folded in) | 2 | 8 | 🟡2 📋4 ⚠️2 | 3 / 1 |
| **mr-side-chrome** | Media Room side resolution (nav/footer fragments per path) | _TEMPLATES.md (MR shell) | header + footer via metadata | 309 (main 88c1b48; draft 825 folded in) | 5 | 5 | 🟡5 | 5 / 10 |
| **cookie-consent** | OneTrust banner + Manage cookies button | — (SKODA-704 stub) | — | 704 (stub), 804 | 3 | 3 | 📋3 | 0 / 0 |
| **page-float-dock** | Floating share expander + scroll-to-top (cart button → 505a) | social-share.md | — (not built) | 215 (main 88c1b48; draft 827 folded in) | 42 | 84 | ❌84 | 84 / 0 |
...
| 20 | Sticky social-share menu | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | COM-15, STO-D10, 215 | Sticky social-share menu @375: present on source → MISSING on EDS |
...
| 22 | Sticky scroll-to-top | page-float-dock | `.sticky-buttons .scroll-top` | 1 | ❌ | NOT-BUILT | 604, 215 | Sticky scroll-to-top @375: present on source → MISSING on EDS |
...
| 19 | Sticky social-share menu | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | COM-15, STO-D10, 215 | Sticky social-share menu @375: present on source → MISSING on EDS |
...
| 21 | Sticky scroll-to-top | page-float-dock | `.sticky-buttons .scroll-top` | 1 | ❌ | NOT-BUILT | 604, 215 | Sticky scroll-to-top @375: present on source → MISSING on EDS |
...
| 18 | Sticky social-share menu | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | COM-15, STO-D10, 215 | Sticky social-share menu @375: present on source → MISSING on EDS |
...
| 20 | Sticky scroll-to-top | page-float-dock | `.sticky-buttons .scroll-top` | 1 | ❌ | NOT-BUILT | 604, 215 | Sticky scroll-to-top @375: present on source → MISSING on EDS |
...
| 13 | Sticky share | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌⚠️ | NOT-BUILT | 215 |  |
| 14 | Sticky cart | media-cart | `.sticky-buttons .media-cart-icon` | 1 | 📋 | NOT-BUILT | 505a, 505b |  |
| 15 | Scroll to top | page-float-dock | `.sticky-buttons .scroll-top` | 1 | ❌⚠️ | NOT-BUILT | 215 |  |
...
| 15 | Sticky share | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌⚠️ | NOT-BUILT | 215 |  |
| 16 | Sticky cart | media-cart | `.sticky-buttons .media-cart-icon` | 1 | 📋 | NOT-BUILT | 505a, 505b |  |
| 17 | Scroll to top | page-float-dock | `.sticky-buttons .scroll-top` | 1 | ❌⚠️ | NOT-BUILT | 215 |  |
...
| 14 | Sticky share | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌⚠️ | NOT-BUILT | 215 |  |
| 15 | Sticky cart | media-cart | `.sticky-buttons .media-cart-icon` | 1 | 📋 | NOT-BUILT | 505a, 505b |  |
| 16 | Scroll to top | page-float-dock | `.sticky-buttons .scroll-top` | 1 | ❌⚠️ | NOT-BUILT | 215 |  |
...
| # | Element | Component | Source selector | × | Status | EDS | Tickets | Top delta |
|--:|---|---|---|--:|:-:|---|---|---|
| 1 | Media Room chrome (header and footer) | mr-side-chrome | `header.header, footer.footer` | 1 | 🟡 | DELTA | 305, 607, 309 | nav/footer variant @1280: News/Press Kits/Models/Images/Videos/Company/Škodapedia + Contacts/Subscribe/Compan… |
...
| 16 | Floating share / social-intent controls | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | 607, 505✓, 215 | element absent @375: visible on source → missing on EDS main |
| 17 | Floating media-cart badge / scroll-top | page-float-dock | `a.media-cart-icon.media-cart-count, a.round-icon.…` | 1 | ❌ | NOT-BUILT | 505✓, 505b, 607, 215 | element absent @375: visible on source → missing on EDS main |
...
| 17 | Floating share / social-intent controls | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | 607, 505✓, 215 | element absent @375: visible on source → missing on EDS main |
| 18 | Floating media-cart badge / scroll-top | page-float-dock | `a.media-cart-icon.media-cart-count, a.round-icon.…` | 1 | ❌ | NOT-BUILT | 505✓, 505b, 607, 215 | element absent @375: visible on source → missing on EDS main |
...
| 18 | Floating share / social-intent controls | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | 607, 505✓, 215 | element absent @375: visible on source → missing on EDS main |
| 19 | Floating media-cart badge / scroll-top | page-float-dock | `a.media-cart-icon.media-cart-count, a.round-icon.…` | 1 | ❌ | NOT-BUILT | 505✓, 505b, 607, 215 | element absent @375: visible on source → missing on EDS main |
...
| 16 | Floating share expander (architect census) | page-float-dock | `div.sticky-buttons > div.sticky-button` | 1 | ❌ | NOT-BUILT | 215 |  |
| 17 | Floating scroll-to-top (architect census) | page-float-dock | `div.sticky-buttons > .round-icon` | 1 | ❌ | NOT-BUILT | 215 |  |
...
| 11 | Floating share expander (architect census) | page-float-dock | `div.sticky-buttons > div.sticky-button` | 1 | ❌ | NOT-BUILT | 215 |  |
| 12 | Floating scroll-to-top (architect census) | page-float-dock | `div.sticky-buttons > .round-icon` | 1 | ❌ | NOT-BUILT | 215 |  |
...
| 12 | Floating share expander (architect census) | page-float-dock | `div.sticky-buttons > div.sticky-button` | 1 | ❌ | NOT-BUILT | 215 |  |
| 13 | Floating scroll-to-top (architect census) | page-float-dock | `div.sticky-buttons > .round-icon` | 1 | ❌ | NOT-BUILT | 215 |  |
...
| 6 | Floating share expander (architect census) | page-float-dock | `div.sticky-buttons > div.sticky-button` | 1 | ❌ | NOT-BUILT | 215 |  |
| 7 | Floating scroll-to-top (architect census) | page-float-dock | `div.sticky-buttons > .round-icon` | 1 | ❌ | NOT-BUILT | 215 |  |
...
| 10 | Floating share expander (architect census) | page-float-dock | `div.sticky-buttons > div.sticky-button` | 1 | ❌ | NOT-BUILT | 215 |  |
| 11 | Floating scroll-to-top (architect census) | page-float-dock | `div.sticky-buttons > .round-icon` | 1 | ❌ | NOT-BUILT | 215 |  |
...
| 21 | Floating share expander (architect census) | page-float-dock | `div.sticky-buttons > div.sticky-button` | 1 | ❌ | NOT-BUILT | 215 |  |
| 22 | Floating scroll-to-top (architect census) | page-float-dock | `div.sticky-buttons > .round-icon` | 1 | ❌ | NOT-BUILT | 215 |  |
...
| 22 | Floating social-share expander | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | 304✓, 215 |  |
| 23 | Floating media-cart badge/count | media-cart | `a.media-cart-icon.media-cart-count.round-icon` | 1 | 📋 | NOT-BUILT | 505a, 505b |  |
| 24 | Floating scroll-to-top button | page-float-dock | `a.round-icon.scroll-top` | 1 | ❌⚠️ | NOT-BUILT | 304✓, 215 |  |
...
| # | Element | Component | Source selector | × | Status | EDS | Tickets | Top delta |
|--:|---|---|---|--:|:-:|---|---|---|
| 1 | MR topbar and section switcher | header-megamenu | `header.header > .topbar` | 1 | ⚠️ | DELTA | 301✓, 305, 309 | MR nav fragment @1280: News / Press Kits / Models / Images / Videos / Company / Škodapedia → STO nav fragment |
| 2 | MR desktop navigation/Models and Company menus | header-megamenu | `nav.topnav` | 1 | ⚠️ | DELTA | 301✓, 305, 309 | menu content @1280: News, Press Kits, Models, Images, Videos, Company, Škodapedia → Models, eMobility, Lifest… |
| 3 | MR wordmark | header-megamenu | `a.logo` | 1 | 🟡 | DELTA | 301✓, 309 | logo anchor width @1280: 256px → 194px |
| 4 | MR mobile hamburger/drawer | mobile-nav | `button.menu-toggle` | 1 | 🟡 | DELTA | 302, 309 | button aria-expanded and scroll-lock @992: button reflects open state, lock html → aria-expanded absent; html… |
| 5 | MR locale links | language-switcher | `.lang-links` | 2 | ⚠️ | DELTA | 303, 309 | translation-aware link availability @1280: six on Images but four on MR press release → six on every page |
| 6 | MR header search/suggestions | header-megamenu | `.search-bar` | 1 | 🔵⚠️ | IN-PR | 403, 309 | trigger width @1280: 48px → 24px |
...
| 17 | MR footer badges and social links | footer-mediaroom | `footer.footer .footer-widgets` | 2 | ⚠️ | DELTA | 305, 306, 309 | footer height/content @1280: 706px MR variant → 842px STO variant |
| 18 | MR footer Contacts links | footer-mediaroom | `footer .widget_nav_menu` | 1 | 📋 | NOT-BUILT | 305, 309 |  |
| 19 | MR footer Subscribe/consent form | newsletter | `footer .skoda-mailguide` | 1 | 📋 | NOT-BUILT | 305, 704 |  |
| 20 | MR footer Company/annual report | footer-mediaroom | `footer .widget_text` | 1 | 📋 | NOT-BUILT | 305, 503, 309 |  |
| 21 | MR-specific copyright/legal/feed bar | footer-mediaroom | `footer .copyright-text` | 1 | 🟡 | DELTA | 305, 306, 309 | footer variant @1280: MR usage wording + RSS target=_blank → STO usage text; RSS target empty |
| 22 | Floating share expander | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | 304✓, 215 |  |
| 23 | Floating media-cart count | media-cart | `a.media-cart-icon.media-cart-count` | 1 | 📋 | NOT-BUILT | 505a, 505b |  |
| 24 | Floating scroll-top | page-float-dock | `a.round-icon.scroll-top` | 1 | ❌⚠️ | NOT-BUILT | 304✓, 215 |  |
...
| # | Element | Component | Source selector | × | Status | EDS | Tickets | Top delta |
|--:|---|---|---|--:|:-:|---|---|---|
| 1 | MR topbar and section switcher | header-megamenu | `header.header > .topbar` | 1 | ⚠️ | DELTA | 301✓, 305, 309 | MR nav fragment @1280: News/Press Kits/Models/Images/Videos/Company/Škodapedia → STO navigation |
| 2 | MR desktop navigation / dropdowns | header-megamenu | `nav.topnav` | 1 | ⚠️ | DELTA | 301✓, 305, 309 | menu labels @1280: News, Press Kits, Models, Images, Videos, Company, Škodapedia → STO navigation set |
| 3 | MR wordmark | header-megamenu | `a.logo` | 1 | 🟡 | DELTA | 301✓, 309 | logo box @1280: 256×48 → 194×19 |
| 4 | MR mobile hamburger/drawer | mobile-nav | `button.menu-toggle` | 1 | 🟡 | DELTA | 302, 309 | toggle ARIA / scroll-lock @375: expanded reflected on button; scroll locked → button aria-expanded absent; ov… |
| 5 | MR language switcher | language-switcher | `.lang-links` | 2 | ⚠️ | DELTA | 303, 309 | locale existence rule @1280: six on Videos, four on MR press article → six static on both |
| 6 | MR header search / suggestions | header-megamenu | `.search-bar` | 1 | 🔵⚠️ | IN-PR | 403, 309 | trigger width @1280: 48px → 24px |
...
| 18 | MR footer badges/social | footer-mediaroom | `footer.footer .footer-widgets` | 2 | ⚠️ | DELTA | 305, 306, 309 | MR footer variant/height @1280: 706px, three MR columns → 842px STO sitemap |
| 19 | MR footer Contacts | footer-mediaroom | `footer .widget_nav_menu` | 1 | 📋 | NOT-BUILT | 305, 309 |  |
| 20 | MR footer subscription/consent | newsletter | `footer .skoda-mailguide` | 1 | 📋 | NOT-BUILT | 305, 704 |  |
| 21 | MR footer Company/annual report | footer-mediaroom | `footer .widget_text` | 1 | 📋 | NOT-BUILT | 305, 503, 309 |  |
| 22 | MR copyright/legal/RSS | footer-mediaroom | `footer .copyright-text` | 1 | 🟡 | DELTA | 305, 306, 309 | legal text/RSS browsing context @1280: MR press/Internet/film rights + RSS target=_blank → STO Internet-news … |
| 23 | Sticky share expander | page-float-dock | `.sticky-buttons .btn-group.social` | 1 | ❌ | NOT-BUILT | 304✓, 215 |  |
| 24 | Sticky media-cart count | media-cart | `a.media-cart-icon.media-cart-count` | 1 | 📋 | NOT-BUILT | 505a, 505b |  |
| 25 | Floating scroll-top | page-float-dock | `a.round-icon.scroll-top` | 1 | ❌⚠️ | NOT-BUILT | 304✓, 215 |  |
