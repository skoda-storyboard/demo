...
| [SKODA-508](tickets/SKODA-508.md) | `skoda-images` turns card-image `data-caption` excerpts into body paragraphs | E05 | 1 | 0.25–0.5 | 0.5–1 | 501 | 🟡 M1; code done + QA 2026-09-25 (10/10 PR re-imports Title-only vs DA); 5 caption PRs await republish approval; follow-ups 509, 612 |
