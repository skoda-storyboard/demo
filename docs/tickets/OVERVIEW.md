...
| [SKODA-605](tickets/SKODA-605.md) | Rewrite absolute source URLs to site-relative in import (#39) | E06 | 2 | 0.5–1 | 1–2 | 601,602 | 🟡 M1; code done 2026-09-25 (`skoda-links.js` in all 16 importers, demo-page allow-list, D-3 (b) for the rest); 1 page republished, the rest ride with 508/603/607/801a/208 |
