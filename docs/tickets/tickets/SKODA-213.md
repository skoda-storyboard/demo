...
Re-evaluate the visual gate with the indexed data: changing the source cures missing dates and external links, but the index image for Peaq may still be a small imported asset, and title/summary content may differ from the source.
