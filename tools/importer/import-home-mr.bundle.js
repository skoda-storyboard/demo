...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-home-mr.js
  var import_home_mr_exports = {};
  __export(import_home_mr_exports, {
    default: () => import_home_mr_default
  });
  ...
  function parse(element, { document: document2 }) {
    ...
    items.forEach((item) => {
      ...
      const title = titleEl && (titleEl.textContent || "").trim() || (anchor.textContent || "").trim() || img && img.getAttribute("alt") || "";
      if (!title) return;
  ...
  return __toCommonJS(import_home_mr_exports);
})();
