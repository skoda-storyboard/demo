...
var CustomImportScript = (() => {
  ...
  var PAGE_TEMPLATE = {
    name: "search-listing",
    description: "\u0160koda site-wide search (body.search). listing.js emits the search variant (no path/template filter; search=true; columns=3). Index-driven over the whole query-index. Metadata template=page.",
