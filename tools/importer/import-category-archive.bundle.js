...
var CustomImportScript = (() => {
  ...
  var import_category_archive_exports = {};
  __export(import_category_archive_exports, {
  ...
  var import_category_archive_default = {
    transform: (payload) => {
      const { document: document2, url, params } = payload;
  ...
  return __toCommonJS(import_category_archive_exports);
})();
