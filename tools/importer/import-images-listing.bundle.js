...
var CustomImportScript = (() => {
  ...
  var import_images_listing_exports = {};
  __export(import_images_listing_exports, {
    default: () => import_images_listing_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "images-listing",
    description: "\u0160koda Images faceted listing (body.images). listing.js emits the images variant (template=image, columns=4, perpage=12). Index-driven; SSR cards + filter stack not ported. Metadata template=page.",
  ...
  var import_images_listing_default = {
    transform: (payload) => {
      const { document: document2, url, params } = payload;
  ...
  return __toCommonJS(import_images_listing_exports);
})();
