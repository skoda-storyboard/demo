...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-videos-listing.js
  var import_videos_listing_exports = {};
  __export(import_videos_listing_exports, {
    default: () => import_videos_listing_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "videos-listing",
    description: "\u0160koda Videos faceted listing (body.videos). listing.js emits the videos variant (template=video, columns=3, perpage=12). Index-driven; SSR cards + filter stack not ported. Metadata template=page.",
  ...
  var import_videos_listing_default = {
    transform: (payload) => {
      const { document: document2, url, params } = payload;
  ...
  return __toCommonJS(import_videos_listing_exports);
})();
